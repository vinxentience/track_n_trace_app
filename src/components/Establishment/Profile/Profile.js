...
import { FaUpload, FaSun, FaMoon, FaTh, FaUserCircle, FaMap, FaEdit} from 'react-icons/fa'
...
const Profile = () => {
    ...
    const [getEstabName, setEstabName] = useState("")
    const [getEstabAddress, setEstabAddress] = useState("")
    ...
    db.collection('users').doc(userUid).get().then(doc => {
        setEstabName(doc.data().estabName)
        setEstabAddress(doc.data().estabAddress)
    })
    ...
    return (
        <>
            ...
            <Container maxW="xl" mt={100} centerContent>
                    ...
                    <Box ml="3">
                        ...
                        isSwitched ?  
                                ...
                                <InputGroup>
                                    ...
                                    />
                                    <Input variant="flushed" defaultValue={getEstabName} />
                                    <InputRightElement children={<FaEdit color="green.500" />} />
                                </InputGroup> 

                                : 

                        <Text fontSize="md"> {getEstabName} </Text> 
                    ...
                    <Box ml="3">
                        ...
                        isSwitched ?  
                                ...
                                <InputGroup>
                                    ...
                                    />
                                    <Input variant="flushed" defaultValue={getEstabAddress} />
                                    <InputRightElement children={<FaEdit color="green.500" />} />
                                </InputGroup> 

                                : 

                        <Text fontSize="md"> {getEstabAddress} </Text> 
                ...
                <Button colorScheme="teal" mt={5} leftIcon={<FaQrcode />} onClick={onOpen}>View QR Code</Button>
                <Modal onClose={onClose} isOpen={isOpenModal} isCentered>
                    ...
                    <ModalContent>
                        ...
                        <Grid templateColumns="repeat(2, 1fr)">
                            ...
                            <Box w="100%"> 
                                <Text fontSize="15px">
                                Fullname: {getEstabName}
                                </Text>

                                <Text fontSize="15px">
                                    Address: {getEstabAddress}
                                </Text>
